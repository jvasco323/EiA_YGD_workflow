...
urlfile <- 'https://raw.githubusercontent.com/jvasco323/EiA_YGD_workflow/main/data-wheat-ethiopia.csv'
...
```{r}
# create final dataset TO REMOVE IN FINAL DATASET!!!
...
The chunk of code below combines the water-limited yield data retrieved from GYGA based on the GPS coordinates of the surveyed households to the main database containing all field level data. The steps needed to retrieve these data from the GYGA API are shown in a **companion notebook**. 

```{r, warning=FALSE}
# load dataframe with yw data
yw_data <- read.csv(file="./data/gps-coordinates.csv", header=TRUE, stringsAsFactors = FALSE)
yw_data <- yw_data[c('hhid', 'cz_code', 'yw_average', 'yw_2009', 'yw_2013')]
